---
title: User-driven, dynamic site theme with CSS
date: 2022/05/21
description: CSS custom properties can help us achieve a dynamically themed site.
tag: web development
author: Victor Foster
---

# User-driven, dynamic site theme with CSS
...
Below you will see an example layout. This is just simplified example to help illustrate. Since I am looking to utilize modern CSS for this version I am using CSS grid with some flexbox for the main page. The colors are all set as variables but with this version I am using CSS Custom Properties instead of LESS variables for the implementation. This allows us to accept the user input and then update the CSS.
...
We've discussed how to create a dynamic theme using css custom properties.
