...
I've enjoyed using [Next.js](https://nextjs.org/) for larger projects and was curious how it might fare for a simple blog. This is an incredibly easy framework to get started with their [learning site](https://nextjs.org/learn/basics/create-nextjs-app). Since I was wanting to be able to write blog posts in Markdown this I discovered [Nextra](https://nextra.vercel.app). Nextra allows for writing in Markdown or with react components using either `.md`, `.mdx`, `.ts`, or `.tsx`. This allow for a lot of flexibility when authoring blog posts.

I also wanted to try authoring in vanilla CSS yet still support legacy browsers through inserting vendor prefixes (where needed) at build time. Luckily [Next.js makes this super easy](https://nextjs.org/docs/advanced-features/customizing-postcss-config#default-behavior) as this feature is built into the framework.

While I've enjoyed working in Next.js, react (in typescript), vanilla CSS (utilizing postcss), I could see myself recreating my blog in the future with tools like [11ty](https://www.11ty.dev/), [Svelte](https://svelte.dev/) or [something](https://www.rust-lang.org/) [different](https://webassembly.org/) just to experiment with different technology. If I do, I'll be sure to provide an update!
